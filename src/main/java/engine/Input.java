...
import praise_sets.Input_praise0;
...
// private.
	...
	{
		_input_praise0 = new Input_praise0();
		try {
	...
	{
		stat_CLASS_create_input_praise0();
		_list_Of_Subset_For_Input = new Object[1];
		try {
		...
		_list_Of_Subset_For_Input[0] = stat_CLASS_get_input_praise0();
	}	
		// get.
