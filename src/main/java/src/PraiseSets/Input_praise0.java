...
// public.
	...
	public float dyn_REG_get_input_valueB()
	{
		...
		// set.
	public void dyn_REG_set_input_valueA(float _input_value)
	{
		stat_REG_set_input_valueA(_input_value);
	}
	public void dyn_REG_set_input_valueB(float _input_value)
	{
		stat_REG_set_input_valueB(_input_value);
	}
	// static.
		// get.
		// set.
...
// private.
	...
	private static float stat_REG_get_input_valueB()
	{
		return _input_valueB;
			...
			// set.
	private static void stat_REG_set_input_valueA(float _input_value)
	{
		_input_valueA = _input_value;
	}
	private static void stat_REG_set_input_valueB(float _input_value)
	{
		_input_valueB = _input_value;
	}
}
