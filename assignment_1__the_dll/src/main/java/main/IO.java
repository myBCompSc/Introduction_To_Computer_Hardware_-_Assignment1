...
// public.
        public static Framework app_generate_Program()
	{
		...
		try {
                    _JavaLIBMath = stat_CLASS_get_Framework().dyn_CLASS_get_App().dyn_CLASS_get_Execute().dyn_PGM_get_LibAdder_ptr();
                }
        ...
        {
            try {
                LIBADDER_API.INSTANCE.app_FUNCT_do_Add(_JavaLIBMath);
            }
	...
	{
            try {
                LIBADDER_API.INSTANCE.app_FUNCT_set_Input_Subset_praise0_valueA(_JavaLIBMath, Global.stat_CONVERT_Float_To_Bytes(newFloat));
            }
	...
	{
            try {
                LIBADDER_API.INSTANCE.app_FUNCT_set_Input_Subset_praise0_valueB(_JavaLIBMath, Global.stat_CONVERT_Float_To_Bytes(newFloat));
            } 
            catch (NullPointerException e) {
                    System.out.printf("NullPointerException.%n");
            }
	...
	public static double dyn_REG_get_praise0_Output_value(Framework obj)
	{
            ...
            try {
                tempDouble = Global.stat_CONVERT_Bytes_To_Double(LIBADDER_API.INSTANCE.app_FUNCT_get_Output_Subset_praise0_value(_JavaLIBMath));
            } 
            catch (NullPointerException e) {
                    System.out.printf("NullPointerException.%n");
            }
